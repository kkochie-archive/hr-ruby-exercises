...
Write a method named full_name that generates the full names of people givien their first name, followed by some variable number of middle names, followed by their last name.
