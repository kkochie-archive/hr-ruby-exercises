=begin
Enumberables - 'any', 'all', 'none', 'find'

Ruby offers various enumberables on collections that check for validity of the objects within it.
...
The all? method returns true if the block never return false or nil for any element passed to it:
...
Task:
Based on the above, complete the functions
