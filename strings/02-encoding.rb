...
You can make the following observations about the code above:
...
Task:
In this challenge, we practice setting the encoding information for some string of text using Ruby's Encoding methods. Write a function name transcode which takes ISO-8859-1 encoded string as a parameter, converts it to an UTF-8 encoded string, and returns the result.

Input Format:
Our hidden code checker will call your function, passing it an ISO-8559-1 encoded string as an argument. 
